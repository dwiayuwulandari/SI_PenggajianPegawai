              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form action="<?php echo base_url('index.php/karyawan/Tambah_Data_Karyawan/') ?>" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <select type="text" id="last-name" name="bagian_karyawan" required="required" class="form-control">
